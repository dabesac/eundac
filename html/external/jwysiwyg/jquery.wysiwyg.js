	...
	function Wysiwyg() {
		...
		this.controls = {
			...
			justifyLeft: {
				...
				tooltip: "Justificar a la derecha"
			},
			...
			justifyRight: {
				...
				tooltip: "Justificar a la izquierda"
			},
			...
			outdent: {
				groupIndex: 2,
				visible: true,
				tooltip: "Indentar a la izquierda"
			},
