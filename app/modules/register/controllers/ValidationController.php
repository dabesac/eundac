...
class Register_ValidationController extends Zend_Controller_Action
{
    ...
    public function saveAction(){
        ...
        if ($this->getRequest()->isPost()){
            ...
            $perid = "15C";//base64_decode($frmdata['perid']);
            $nota = $frmdata['nota'];
    ...
    public function printAction(){
        ...
        $wheri = array('eid'=>$eid,'oid'=>$oid,'uid'=>$uid,'pid'=>$pid,'escid'=>$escid,'subid'=>$subid,'type_impression'=>'registro_notas','perid'=>$perid);
        ...
        if ($dataim) {
            ...
            $data = array(
                ...
                'subid'=>$subid,
                'pid'=>$pid,
                'type_impression'=>'registro_notas',
